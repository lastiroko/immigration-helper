...
/**
 * Shared shell for the residence-permit screens. Reuses the Anmeldung
 * footer pattern but with Ausländerbehörde-specific official-source
 * link. Plain layout — real visual polish lands once individual screens
 * are spec-verified and built out.
 */
